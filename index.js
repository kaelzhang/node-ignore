...
// A bracket expression never matches a slash (gitignore(5), fnmatch(3)),
//   but JS `[^...]` would, so `/` is added to the negated set to exclude it.
//   The `/` is already escaped to `\/` by the slash replacer that runs first.
